            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Mis Tweets</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Lista de tweets escritos</h3>
                    </div>
                    <!-- /.card-header -->
                <form method="POST" action="{{ route('borrarTweets') }}">
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            <button class="btn btn-block btn-danger" type="submit"> Borrar los Tweets seleccionados </button>
                        </div>
                        <div>
                        ...
                        <table id="myTweets" class="table table-bordered table-striped">
                            ...
                            <tbody>
                            @foreach($misTweets as $tweet)
                                <tr>
                                    <td><input type="checkbox" id="cb{{ $tweet->getId() }}" name="selectedTweets[]" value="{{ $tweet->getId() }}" onclick="getNumSelectedTweets()" /></td>
...
@section('footer')
    ...
    <script>
        ...
        function checkAll(source) {
            checkboxes = document.getElementsByName('selectedTweets[]');
